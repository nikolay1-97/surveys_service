...
describe('ManageSurveysController (e2e)', () => {
  ...
  it('/admins/surveys (GET)', async () => {
    ...
    return request(app.getHttpServer())
      ...
      .expect((response) => {
        return (
          response.body[0].title === 'survey1' &&
          response.body[0].owner_id === 1 &&
          response.body[1].title === 'survey3' &&
          response.body[1].owner_id === 1 &&
          response.body[2].title === 'survey4' &&
          response.body[2].owner_id === 1
        );
      });
  }),
    it('/admins/surveys/1/questions (GET)', async () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect((response) => {
          return (
            response.body[0].question === 'question1' &&
            response.body[0].survey_id === 1 &&
            response.body[0].type === 'single choice' &&
            response.body[1].question === 'question2' &&
            response.body[0].survey_id === 1 &&
