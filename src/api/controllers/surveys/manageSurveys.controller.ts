...
export class ManageSurveysController {
  ...
  async changeQuestion(
    ...
    const question = await this.questionsService.changeQuestion(
      question_id,
      id,
      admin_id,
      dto,
  ...
  async changeType(
    ...
    const question = await this.questionsService.changeType(
      question_id,
      admin_id,
      dto,
    );
  ...
  async changeTitleOption(
    ...
    const option = await this.optionsService.changeTitle(
      id,
      question_id,
      admin_id,
      dto,
