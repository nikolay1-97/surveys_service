...
describe('SurveysForUsersController (e2e)', () => {
  ...
  it('/surveys (GET)', async () => {
    ...
    return request(app.getHttpServer())
      ...
      .expect((response) => {
        return (
          response.body[0].title === 'surveys1' &&
          response.body[0].owner_id === 1 &&
          response.body[1].title === 'surveys2' &&
          response.body[1].owner_id === 2
        );
      });
  }),
      ...
      return request(app.getHttpServer())
        ...
        .expect((response) => {
          return (
            ...
            response.body[1]['questions'][1]['options'][1]['title'] ===
              'option1'
          );
        });
    }),
      ...
      return request(app.getHttpServer())
        ...
        .expect((response) => {
          return (
            ...
            response.body[1].survey_id === 1 &&
            response.body[1].questions === 'question2' &&
