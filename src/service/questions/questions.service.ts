...
export class QuestionsService {
  ...
  async create(
    ...
    const question = await this.questionsRepository.getBySurveyIdAndQuestion(
      survey_id,
      dto.question,
    );
  ...
  async delete(
    ...
    const question = await this.questionsRepository.getByIdOwnerId(
      id,
      owner_id,
    );
